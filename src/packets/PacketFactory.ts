...
//11:death->clan_join_request
//10:clan_join_request->???
...
packetTypeMapping[PacketType.CHAT] = { value: "ch", side: Side.Both };//ok
...
packetTypeMapping[PacketType.CLAN_CREATE] = { value: "8", side: Side.Server };//ok
...
packetTypeMapping[PacketType.CLAN_REQ_JOIN] = { value: "11", side: Side.Server };
...
packetTypeMapping[PacketType.BUY_AND_EQUIP] = { value: "13c", side: Side.Server };//ok, maybe side wrong?
packetTypeMapping[PacketType.HEALTH_UPDATE] = { value: "h", side: Side.Client };//ok
packetTypeMapping[PacketType.ITEM_BUY] = { value: "13", side: Side.Client };//outdated see BUY AND EQUIP
packetTypeMapping[PacketType.LEADERBOARD_UPDATE] = { value: "5", side: Side.Client };//conflict
packetTypeMapping[PacketType.LEAVE_CLAN] = { value: "9", side: Side.Server };
packetTypeMapping[PacketType.LOAD_GAME_OBJ] = { value: "6", side: Side.Client };//conflict
...
packetTypeMapping[PacketType.SELECT_ITEM] = { value: "5", side: Side.Server };//ok
packetTypeMapping[PacketType.SELECT_UPGRADE] = { value: "6", side: Side.Server };//ok
...
packetTypeMapping[PacketType.UPDATE_AGE] = { value: "15", side: Side.Client };//ok
packetTypeMapping[PacketType.UPDATE_HEALTH] = { value: "h", side: Side.Client };
packetTypeMapping[PacketType.CLAN_NOTIFY_SERVER] = { value: "14", side: Side.Server };//old?
packetTypeMapping[PacketType.CLAN_NOTIFY_CLIENT] = { value: "p", side: Side.Client };//old?
packetTypeMapping[PacketType.UPDATE_PLACE_LIMIT] = { value: "14", side: Side.Client };
packetTypeMapping[PacketType.SPAWN] = { value: "sp", side: Side.Server };//ok
...
packetTypeMapping[PacketType.UPGRADES] = { value: "16", side: Side.Client };//ok
packetTypeMapping[PacketType.WIGGLE] = { value: "8", side: Side.Client };
packetTypeMapping[PacketType.WINDOW_FOCUS] = { value: "rmd", side: Side.Server };//ok
packetTypeMapping[PacketType.PLAYER_ADD] = { value: "2", side: Side.Client };//ok
...
packetTypeMapping[PacketType.HEALTH_CHANGE] = { value: "t", side: Side.Client };//ok?? ça marche en tt cas (a comprendre en attaquer???)
